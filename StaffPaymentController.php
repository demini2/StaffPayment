...
class StaffPaymentController
{
     ...
     * @param StaffPaymentService $paymentService
    ...
    public function index(
        ...
        StaffPaymentService                                                                             $paymentService,
        ...
        $fData = function($offset, $limit) use ($sort, $direction, $paymentService, $staffForm) {
            return $paymentService->getDtoByStaffPayment(
                offset: $offset,
                limit: $limit,
                sort: $sort,
                direction: $direction,
